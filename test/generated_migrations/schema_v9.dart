...
class Habits extends Table with TableInfo<Habits, HabitsData> {
  ...
  late final GeneratedColumn<int> isNegative = GeneratedColumn<int>(
    'is_negative',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (is_negative IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> cleanSince = GeneratedColumn<int>(
    'clean_since',
    aliasedName,
    true,
    type: DriftSqlType.int,
...
class HabitsData extends DataClass implements Insertable<HabitsData> {
  ...
  final int isNegative;
  final int? cleanSince;
  final int isDeleted;
  final int createdAt;
  final int updatedAt;
  const HabitsData({
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_negative'] = Variable<int>(isNegative);
    if (!nullToAbsent || cleanSince != null) {
      map['clean_since'] = Variable<int>(cleanSince);
    }
  ...
  factory HabitsData.fromJson(
    ...
    return HabitsData(
      ...
      isNegative: serializer.fromJson<int>(json['isNegative']),
      cleanSince: serializer.fromJson<int?>(json['cleanSince']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isNegative': serializer.toJson<int>(isNegative),
      'cleanSince': serializer.toJson<int?>(cleanSince),
  ...
  HabitsData copyWith({
    ...
    int? isNegative,
    Value<int?> cleanSince = const Value.absent(),
    int? isDeleted,
    int? createdAt,
    int? updatedAt,
  }) => HabitsData(
...
class HabitsCompanion extends UpdateCompanion<HabitsData> {
  ...
  final Value<int> isNegative;
  final Value<int?> cleanSince;
  ...
  static Insertable<HabitsData> custom({
    ...
    Expression<int>? isNegative,
    Expression<int>? cleanSince,
  ...
  HabitsCompanion copyWith({
    ...
    Value<int>? isNegative,
    Value<int?>? cleanSince,
    Value<int>? isDeleted,
    Value<int>? createdAt,
    Value<int>? updatedAt,
    Value<int>? rowid,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isNegative.present) {
      map['is_negative'] = Variable<int>(isNegative.value);
    }
    if (cleanSince.present) {
      map['clean_since'] = Variable<int>(cleanSince.value);
    }
...
class HabitLogs extends Table with TableInfo<HabitLogs, HabitLogsData> {
  ...
  late final GeneratedColumn<String> targetTier = GeneratedColumn<String>(
    'target_tier',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  HabitLogsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return HabitLogsData(
      ...
      targetTier: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class HabitLogsData extends DataClass implements Insertable<HabitLogsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || targetTier != null) {
      map['target_tier'] = Variable<String>(targetTier);
    }
  ...
  factory HabitLogsData.fromJson(
    ...
    return HabitLogsData(
      ...
      targetTier: serializer.fromJson<String?>(json['targetTier']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'targetTier': serializer.toJson<String?>(targetTier),
  ...
  HabitLogsData copyWith({
    ...
    Value<String?> targetTier = const Value.absent(),
...
class HabitLogsCompanion extends UpdateCompanion<HabitLogsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (targetTier.present) {
      map['target_tier'] = Variable<String>(targetTier.value);
    }
    if (note.present) {
...
class HabitRoutines extends Table
    with TableInfo<HabitRoutines, HabitRoutinesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  HabitRoutines(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> targetTimeWindow = GeneratedColumn<String>(
    'target_time_window',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  HabitRoutinesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return HabitRoutinesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
      ...
      targetTimeWindow: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  HabitRoutines createAlias(String alias) {
    return HabitRoutines(attachedDatabase, alias);
  }
...
class HabitRoutinesData extends DataClass
    implements Insertable<HabitRoutinesData> {
  final String id;
  final String title;
  final String? description;
  final String? icon;
  final String color;
  final String? targetTimeWindow;
  final String habitIds;
  final int bonusXp;
  final int isDeleted;
  final int createdAt;
  final int updatedAt;
  const HabitRoutinesData({
    required this.id,
    required this.title,
    this.description,
    this.icon,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || targetTimeWindow != null) {
      map['target_time_window'] = Variable<String>(targetTimeWindow);
    }
  ...
  factory HabitRoutinesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return HabitRoutinesData(
      ...
      icon: serializer.fromJson<String?>(json['icon']),
      color: serializer.fromJson<String>(json['color']),
      targetTimeWindow: serializer.fromJson<String?>(json['targetTimeWindow']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'icon': serializer.toJson<String?>(icon),
      'color': serializer.toJson<String>(color),
      'targetTimeWindow': serializer.toJson<String?>(targetTimeWindow),
  ...
  HabitRoutinesData copyWith({
    String? id,
    String? title,
    Value<String?> description = const Value.absent(),
    Value<String?> icon = const Value.absent(),
    String? color,
    Value<String?> targetTimeWindow = const Value.absent(),
    String? habitIds,
    int? bonusXp,
    int? isDeleted,
    int? createdAt,
  ...
  HabitRoutinesData copyWithCompanion(HabitRoutinesCompanion data) {
    return HabitRoutinesData(
      id: data.id.present ? data.id.value : this.id,
      title: data.title.present ? data.title.value : this.title,
      description: data.description.present
  ...
  @override
  String toString() {
    return (StringBuffer('HabitRoutinesData(')
          ..write('id: $id, ')
          ..write('title: $title, ')
          ..write('description: $description, ')
          ..write('icon: $icon, ')
...
class HabitRoutinesCompanion extends UpdateCompanion<HabitRoutinesData> {
  final Value<String> id;
  final Value<String> title;
  final Value<String?> description;
  final Value<String?> icon;
  final Value<String> color;
  final Value<String?> targetTimeWindow;
  ...
  HabitRoutinesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<HabitRoutinesData> custom({
    Expression<String>? id,
    Expression<String>? title,
    Expression<String>? description,
    Expression<String>? icon,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (targetTimeWindow.present) {
      map['target_time_window'] = Variable<String>(targetTimeWindow.value);
    }
    if (habitIds.present) {
...
class RoutineLogs extends Table with TableInfo<RoutineLogs, RoutineLogsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RoutineLogs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> completedHabitIds =
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  RoutineLogsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return RoutineLogsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
      ...
      completedHabitIds: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  RoutineLogs createAlias(String alias) {
    return RoutineLogs(attachedDatabase, alias);
  }
...
class RoutineLogsData extends DataClass implements Insertable<RoutineLogsData> {
  final String id;
  final String routineId;
  final String date;
  final int completedAt;
  final String completedHabitIds;
  final int xpEarned;
  final int isDeleted;
  final int createdAt;
  final int updatedAt;
  const RoutineLogsData({
    required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['completed_habit_ids'] = Variable<String>(completedHabitIds);
  ...
  factory RoutineLogsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return RoutineLogsData(
      ...
      completedHabitIds: serializer.fromJson<String>(json['completedHabitIds']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'completedHabitIds': serializer.toJson<String>(completedHabitIds),
  ...
  RoutineLogsData copyWith({
    String? id,
    String? routineId,
    String? date,
    int? completedAt,
    String? completedHabitIds,
    int? xpEarned,
    int? isDeleted,
    int? createdAt,
    int? updatedAt,
  ...
  RoutineLogsData copyWithCompanion(RoutineLogsCompanion data) {
    return RoutineLogsData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('RoutineLogsData(')
          ..write('id: $id, ')
...
class RoutineLogsCompanion extends UpdateCompanion<RoutineLogsData> {
  final Value<String> id;
  final Value<String> routineId;
  final Value<String> date;
  final Value<int> completedAt;
  final Value<String> completedHabitIds;
  ...
  RoutineLogsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<RoutineLogsData> custom({
    Expression<String>? id,
  ...
  RoutineLogsCompanion copyWith({
    ...
    Value<String>? completedHabitIds,
    Value<int>? xpEarned,
    Value<int>? isDeleted,
    Value<int>? createdAt,
    Value<int>? updatedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (completedHabitIds.present) {
      map['completed_habit_ids'] = Variable<String>(completedHabitIds.value);
    }
    if (xpEarned.present) {
...
class DatabaseAtV9 extends GeneratedDatabase {
  ...
  late final HabitRoutines habitRoutines = HabitRoutines(this);
  late final RoutineLogs routineLogs = RoutineLogs(this);
