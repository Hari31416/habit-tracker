...
void main() {
  group('Screen.fromUri', () {
    ...
    test('daily uris map to daily route', () {
      expect(Screen.fromUri('phial://habits/daily'), Screen.daily);
      expect(Screen.fromUri('phial://habits'), Screen.daily);
    ...
    test('matrix uris map to matrix route', () {
      expect(Screen.fromUri('phial://habits/matrix'), Screen.matrix);
    ...
    test('analytics uris map to analytics route', () {
      expect(Screen.fromUri('phial://habits/analytics'), Screen.analytics);
    ...
    test('badges uris map to badges route', () {
      expect(Screen.fromUri('phial://habits/badges'), Screen.badges);
    ...
    test('detail uris with valid id map to detail route', () {
      expect(
        Screen.fromUri('phial://habits/detail/h_123'),
        'detail/h_123',
      );
      expect(
    ...
    test('detail uris with empty or missing id fallback to daily', () {
      expect(Screen.fromUri('phial://habits/detail'), Screen.daily);
      expect(Screen.fromUri('phial://habits/detail/'), Screen.daily);
    ...
    test('focus_timer uris with valid id map to focus_timer route', () {
      expect(
        Screen.fromUri('phial://habits/focus_timer/timer_1'),
        'focus_timer/timer_1',
      );
      expect(
