...
class BackupRepositoryImpl implements BackupRepository {
  ...
  HabitsCompanion _habitToCompanion(Habit h) => HabitsCompanion(
        ...
        miniTargetValue: Value(h.miniTargetValue),
        eliteTargetValue: Value(h.eliteTargetValue),
        unit: Value(h.unit),
        ...
        healthMetric: Value(h.healthMetric),
        healthSyncEnabled: Value(h.healthSyncEnabled),
