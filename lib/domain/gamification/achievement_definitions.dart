...
class AchievementDefinitions {
  static const List<AchievementDefinition> allAchievements = [
    ...
    // Routine Chains & Habit Stacking
    AchievementDefinition(
      id: 'routine_1',
      title: 'Chain Reaction',
      description: 'Complete your first habit routine sequence.',
      category: AchievementCategory.routines,
      tier: AchievementTier.bronze,
      iconName: 'link',
      xpReward: 50,
      targetValue: 1,
    ...
    AchievementDefinition(
      id: 'routine_5',
      title: 'Habit Stacker',
      description: 'Complete 5 habit routine sequences.',
      category: AchievementCategory.routines,
      tier: AchievementTier.bronze,
      iconName: 'layers',
      xpReward: 100,
    ...
    AchievementDefinition(
      ...
      description: 'Complete 25 habit routine sequences.',
      category: AchievementCategory.routines,
      tier: AchievementTier.silver,
      iconName: 'zap',
      xpReward: 300,
    ...
    AchievementDefinition(
      ...
      description: 'Achieve 100 completed habit routine sequences.',
      category: AchievementCategory.routines,
      tier: AchievementTier.platinum,
      iconName: 'trophy',
      xpReward: 1000,
    ...
    AchievementDefinition(
      id: 'routine_morning_7',
      title: 'Morning Virtuoso',
      description: 'Complete a morning routine sequence 7 times.',
      category: AchievementCategory.routines,
      tier: AchievementTier.silver,
      iconName: 'sun',
      xpReward: 200,
      targetValue: 7,
      unit: 'morning routines',
    ),
